...
CREATE TABLE regions_for_sql (
  ...
  region_code VARCHAR(10) NOT NULL COMMENT 'INSEE region code (source)',
...
CREATE TABLE population_for_sql (
  region_code VARCHAR(10) NOT NULL COMMENT 'INSEE region code (FK to regions_for_sql)',
  region_name VARCHAR(255) NULL COMMENT 'Region name (source)',
  nb_arrondissements VARCHAR(32) NULL,
  nb_cantons VARCHAR(32) NULL,
  nb_communes VARCHAR(32) NULL,
  population_municipale VARCHAR(32) NULL,
  population_totale VARCHAR(32) NULL,
  PRIMARY KEY (region_code),
...
CREATE TABLE departments_for_sql (
  ...
  region_code VARCHAR(10) NOT NULL COMMENT 'Parent region code',
...
CREATE TABLE communes_for_sql (
  ...
  commune_code VARCHAR(10) NOT NULL COMMENT 'INSEE commune code',
...
CREATE TABLE income_communes_for_sql (
  ...
  median_income VARCHAR(32) NULL,
  poverty_rate VARCHAR(32) NULL,
  income_d1 VARCHAR(32) NULL,
  income_d9 VARCHAR(32) NULL,
  income_inequality_ratio VARCHAR(32) NULL,
  gini_index VARCHAR(32) NULL,
  income_q1 VARCHAR(32) NULL,
  income_q3 VARCHAR(32) NULL,
...
CREATE TABLE income_iris_for_sql (
  ...
  code_insee VARCHAR(64) NULL COMMENT 'Parent commune INSEE code',
  median_income VARCHAR(32) NULL,
  poverty_rate VARCHAR(32) NULL,
  income_d1 VARCHAR(32) NULL,
  income_d9 VARCHAR(32) NULL,
...
CREATE TABLE basilic_for_sql (
  ...
  code_insee VARCHAR(64) NULL COMMENT 'Raw field; may contain multiple comma-separated INSEE codes',
